...
class RecyclerDataMhs extends RecyclerView.Adapter<RecyclerDataMhs.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            nama = (TextView) view.findViewById(R.id.tvNamaRv);
            nim = (TextView) view.findViewById(R.id.tvNimRv);
            cardnyamereka = view.findViewById(R.id.cdItemMahasiswa);
        }
    }
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.cardnyamereka.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(), namaTampil, Toast.LENGTH_SHORT).show();
